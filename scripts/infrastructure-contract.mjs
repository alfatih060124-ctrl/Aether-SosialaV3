...
requireText('gateway', gateway, '/api/account/wallet-portfolio');
...
requireText('gateway', gateway, '/api/account/copy-trades');
...
requireText('vercel', vercel, '"dest": "/public/member.html"');
...
requireText('caddy', caddy, '/api/account/wallet-portfolio');
requireText('caddy', caddy, '/api/account/trader');
...
requireText('caddy', caddy, '/api/account/copy-trades');
...
requireText('primary server', server, "route==='/api/account/wallet-portfolio'");
...
requireText('primary server', server, "route==='/api/account/copy-trades'");
...
requireText('primary server', server, "route==='/api/admin/live-control'");
requireText('primary server', server, "route==='/api/admin/subscriptions'");
requireText('primary server', server, "route==='/api/admin/subscriptions/prices'");
requireText('primary server', server, "route==='/api/admin/members'");
requireText('primary server', server, "route==='/api/admin/fees/history'");
requireText('primary server', server, "route==='/api/admin/fees/apply-shadow'");
...
requireText('primary server', server, 'position_accounting_ready:false');
...
const accountStrategy = read('public/account-auto-strategy.js');
...
requireText('account strategy', accountStrategy, '/api/account/copy-trades');
requireText('account strategy', accountStrategy, 'Active Trades & Copy Activity');
requireText('account strategy', accountStrategy, 'Open-position PnL is not inferred from execution requests.');
