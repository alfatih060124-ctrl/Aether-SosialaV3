...
console.log(JSON.stringify({ok:true,fixture_policy:'SYNTHETIC_TEST_ONLY',schema:e.schema,tests:31,collection_status:e.collection_status,metrics_available:e.metrics_available,verified:e.verified,published:e.published}));
