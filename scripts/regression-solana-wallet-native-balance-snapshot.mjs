...
const requestedAt='2026-09-05T00:00:00.000Z';
const observedAt='2026-09-05T00:00:01.000Z';
...
for(const mutate of [
 e=>{e.verified=true;},e=>{e.published=true;},e=>{e.metrics_available=true;},e=>{e.trades_count=1;},e=>{e.calculation_hash='0'.repeat(64);},e=>{e.source_reference='solana_rpc:synthetic@1';},
