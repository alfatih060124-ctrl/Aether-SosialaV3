...
const migration = fs.readFileSync('migrations/016_product_audit_separation_gates.sql', 'utf8');
...
assert(/OLD\.verification_status IS DISTINCT FROM 'VERIFIED'/i.test(migration), 'publication must be separated from same-write verification');
