...
const result = await runtime.scanAndQualifyPair({
  token_mint: 'TOKEN', quote_mint: 'USDC', demo_account: { cash_balance_usdc: 2000, open_position: {} }
});
...
await assert.rejects(() => feeBlocked.scanAndQualifyPair({ token_mint: 'TOKEN', quote_mint: 'USDC', demo_account: { cash_balance_usdc: 2000, open_position: {} } }), /shadow_network_fee_unverified/);
...
await assert.rejects(() => riskBlocked.scanAndQualifyPair({ token_mint: 'TOKEN', quote_mint: 'USDC', demo_account: { cash_balance_usdc: 2000, open_position: {} } }), /shadow_risk_evidence_unverified/);
