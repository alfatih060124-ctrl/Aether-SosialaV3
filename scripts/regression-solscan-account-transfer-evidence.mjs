...
for(const mutate of[e=>{e.verified=true;},e=>{e.published=true;},e=>{e.trades_count=2;},e=>{e.total_return_bps=10;},e=>{e.source_reference=e.rows[0].source_reference;},e=>{e.rows[0].amount_base_units=1;},e=>{e.provenance.rows[0].token_decimals=9;},e=>{e.evidence_count=99;}]){const e=structuredClone(good);mutate(e);assert.equal(verifySolscanAccountTransferEvidence(e),false);}
