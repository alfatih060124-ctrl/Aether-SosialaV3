...
export function buildAutoTradeMandateFromPersisted(row, authenticatedFollowerUserId, runtimeRisk) {
  ...
  // Runtime semantics are intentionally conservative until percentage/proportional
  // policy sizing receives its own canonical contract. Unsupported policy types
  // fail closed rather than being guessed here.
