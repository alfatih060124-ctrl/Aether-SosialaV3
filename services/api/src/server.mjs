...
const server=http.createServer(async(req,res)=>{try{
 ...
 if(req.method==='PATCH'&&route==='/api/admin/fees')return send(res,409,{error:'fee_control_lifecycle_required',mode:'SHADOW',live_execution_authorized:false,network_submission_authorized:false,signer_required:false});
