...
export function verifySolanaWalletNativeBalanceSnapshot(e){
  if(!plain(e)||e.schema!=='aether.solana.wallet_native_balance_snapshot.v2')return false;
